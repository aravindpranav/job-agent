...
# Manchester, Birmingham, Melbourne, Paris, Vienna, Ontario, ...): those are
# disambiguated by an explicit country token instead, never by the city alone.
_CITY_COUNTRY: dict[str, tuple[str, ...]] = {
    ...
    "Canada": ("toronto", "vancouver", "montreal", "mississauga", "calgary", "waterloo"),
